...
/**
 * Un checker are forma:
 *  { pattern: /something/, points: 1 }
 * si daca patternul se aseamana doar la inceputul doc:
 *  { pattern: /something/, points: 2, nearTop: true }
 * 
 * Key: limbaj
 * Value: array de checkeri
 * 
 *
 * Puncte
 *  2 = Bonus:   aproape unic pentru un anumit limbaj
 *  1 = Normal:  nu e unic pentru un anumit limbaj
 * -1 = Penalty:  nu corespunde cu un anumit limbaj
 * Rar:
 * -50 = Bonus penalty: folosit doar cand doua limbaje sunt folosite impreuna
 * si unul are precedenta mai mare peste celalalt
 */
var languages = {
	'JavaScript': [
		// undefined keyword
